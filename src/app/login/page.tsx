        ...
        <div className="grid min-h-[620px] grid-cols-1 lg:grid-cols-3">
          ...
          >
            ...
            <Stack spacing={1}>
              ...
              <Typography variant="body2" className="text-slate-500">
                Sign in to manage courses, content, and users.
              </Typography>
            </Stack>
            ...
            <Button
              ...
              size="large"
              disabled={
                loginMutation.isPending || username.trim().length === 0 || password.length === 0
              }
              startIcon={<LoginIcon />}
              sx={{
                borderRadius: "14px",
          ...
          <div className="relative hidden overflow-hidden border-l border-slate-200 bg-[#EAF1FF] lg:block">
            ...
            >
              ...
              <rect width="960" height="1120" fill="url(#miraigo-admin-squiggle)" />
